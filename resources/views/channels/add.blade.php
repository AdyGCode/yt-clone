                ...
                <div class="container mx-auto p-4 pt-6 gap-4">
                    ...
                    <!-- Channel Name -->
                        <div class="container mx-auto px-4 py-1 mt-6 flex flex-row flex-wrap">
                            ...
                            <p class="sm text-red-50 bg-red-500 p-1 pl-3 flex-1 basis-3/4">Error: {{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="container mx-auto px-4 py-1 flex flex-row flex-wrap">
                            ...
                            @error('user_id')
                            <span class="flex-none basis-1/4"></span>
                            <p class="sm text-red-50 bg-red-500 p-1 pl-3 flex-1 basis-3/4">Error: Channel owner must be selected</p>
                            @enderror
                        </div>
                        ...
                        <div class="container mx-auto px-4 py-1 flex flex-row flex-wrap">
                            ...
                            <span class="flex-none basis-1/4"></span>
                            <span class="flex-wrap basis-1/1 text-sm text-stone-500">Leave blank for default slug.</span>
                        </div>
